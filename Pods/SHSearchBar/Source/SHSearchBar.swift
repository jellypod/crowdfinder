...
public class SHSearchBar: UIView, UITextFieldDelegate {
    ...
    private func setupCancelButton(_ config: SHSearchBarConfig) {
        ...
        cancelButton.setContentHuggingPriority(UILayoutPriority.required, for: .horizontal)
    ...
    func updateUI() {
        ...
        textField.defaultTextAttributes = [NSAttributedStringKey.foregroundColor.rawValue:normalTextColor, NSAttributedStringKey.backgroundColor.rawValue: config.textBackgroundColor]
